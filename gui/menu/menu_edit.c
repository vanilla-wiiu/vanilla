...
static void region_btn_pressed(vui_context_t *vui, int button, void *v)
{
    vui_transition_fade_layer_out(vui, fglayer, vpi_menu_region, v);
}
...
void vpi_menu_edit_nofade(vui_context_t *vui, void *v)
{
    ...
    const int btn_y = bkg_rect.y + bkg_rect.h * 1 / 3;
    ...
    vui_button_create(vui, bkg_rect.x + bkg_rect.w/2 - btn_w/2, btn_y + BTN_SZ*2, btn_w, BTN_SZ, lang(VPI_LANG_REGION), 0, VUI_BUTTON_STYLE_BUTTON, fglayer, region_btn_pressed, v);
