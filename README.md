...
- [Nintendo Switch](https://github.com/vanilla-wiiu/vanilla/wiki/Linux-Setup-Guide) (internal Wi-Fi usable via [patch](https://github.com/vanilla-wiiu/nexmon) - [external Wi-Fi adapter](https://github.com/vanilla-wiiu/vanilla/wiki/Linux-Setup-Guide#nintendo-switch) often simpler due to patch complexity)
