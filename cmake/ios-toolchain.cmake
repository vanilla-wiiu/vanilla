...
if(NOT DEFINED CMAKE_OSX_DEPLOYMENT_TARGET)
    ...
    if(NOT _vanilla_xcode_version_result EQUAL 0)
        message(FATAL_ERROR "Could not determine the selected Xcode version: ${_vanilla_xcode_version_error}")
    endif()

    string(REGEX MATCH "Xcode ([0-9]+(\\.[0-9]+)*)" _vanilla_xcode_version_match "${_vanilla_xcode_version_output}")
    if(NOT CMAKE_MATCH_1)
        message(FATAL_ERROR "Could not parse the selected Xcode version from: ${_vanilla_xcode_version_output}")
    endif()
...
if(IS_DIRECTORY "${CMAKE_OSX_SYSROOT}")
    ...
    if(NOT _vanilla_ios_sdk_result EQUAL 0 OR NOT IS_DIRECTORY "${VANILLA_IOS_SDK_PATH}")
        message(FATAL_ERROR "Could not resolve iOS SDK '${CMAKE_OSX_SYSROOT}': ${_vanilla_ios_sdk_error}")
    endif()
endif()
